...
const ListTable = (props) => {
    ...
    useEffect(() => {
        fetch(`http://localhost:8100/article/area=${props.areaCode}`)
                                ...
                                .map((article, index) => {
                                    ...
                                    return (
                                        ...
                                        >
                                            ...
                                            <TableCell align="center">{article.writer}</TableCell>
                                            <TableCell align="center">{article.uploadDate}</TableCell>

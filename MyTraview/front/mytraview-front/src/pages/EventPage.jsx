...
const EventPage = () => {
  ...
  return (
    <>
      ...
      <div className="bg-[url('/public/images/starSky.jpg')] opacity-80 bg-cover" style={{ height: "100vh" }}>
        <br /><br /><br /><br /><br />
        <div className='px-96'>
          ...
          <div className="box-content h-5 py-5 mb-2 ml-4 text-2xl font-bold text-center text-gray-200 border-4 border-x-transparent w-[420px]">
            이벤트 하는 곳 목록을 볼 수 있습니다.
          </div>
